...
<body>
    ...
    <!--akhir navbar-->
<p><a href="tambahjadwal.php">tambahkan</a></p>
<div class="container">
        ...
        <tbody>
            ...
            <?php foreach ($jadwal as $row) : ?>
                <tr>
                    ...
                    <th><?= $row["sampai"]; ?></th>
                    <th><?= $row["harga"]; ?></th>
                    <td><a href="editjadwal.php?id=<?php echo $data['idTiket'] ?>">edit</a> <a href="hapus.php?id=<?php echo $data['idTiket'] ?>" onclick="return confirm('Apakah anda ingin menghapus data ini?')">hapus</a></td>
                </tr>
                <?php $i++; ?>
            <?php endforeach; ?>
        </tbody>
